...
Usually `CodeReview </sphinxwiki/content/pages/CodeReview.html>`_ is done by module, and only after the fact.  While this practice is useful, it only raises problems that already exist, it doesn't prevent them.
