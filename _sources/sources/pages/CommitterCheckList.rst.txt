...
#. All code committed to trunk must go through the `Review Process </sphinxwiki/content/pages/ReviewProcess.html>`_ .
#. trunk commit messages must follow the format described on `Review Process </sphinxwiki/content/pages/ReviewProcess.html>`_ so that various pieces of automation can work.
